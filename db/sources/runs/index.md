...
- [[sources/runs/2026/09/2026-09-03-verify-tools-v1-postmerge-green-macbook-pro-m3-max]] — Post-merge full battery on tools-v1: 191 PASS / 0 FAIL (robustness 75/0), including the sweep gates from 0.2.3 and the two gate fixes (unseeded variation, long-context token budget).
