---
type: run
id: 01m1vtpwn169k4xa16dz11yt84
created: 2026-09-06T17:01:59.841864+00:00
updated: 2026-09-06T17:02:21.566307+00:00
summary: Reference-aware key padding preserves nine numerical failures
...
title: Reference-aware key padding preserves nine numerical failures
tool: Native Swift diagnostics and Python CLI gates
---
# Reference-aware key domains do not fix the remaining numerical divergence

Build 11's `context-small-swept-aligned-64` retains the frozen 515 IDs,
256 reference, 512 rechunk control, repeated 64 candidate, teacher-forced
continuations and speculative rollback. The candidate pads masked attention
keys only to the canonical reference pass end and preserves the reference
terminal pass's expert dispatch. Padding follows the actual prefix origin and
prompt end, rather than globally rounding a partial terminal prompt.

The unchanged gate fails 9 of 1605 assertions: continuation greedy tokens and
rollback state still disagree beyond their frozen criteria. This is the same
nine-failure set as the router-shape predecessor. Full candidate repeatability
passes. Prefill state/logit bands pass but are not exact: the earliest retained
state difference is the indexer in layer 3. No tolerance or expected output
was changed, and neither larger capacity nor answer quality is established.

This single short model run overlapped an explicitly coordinated, separate
anonymous model download. All timings and capacity interpretations are excluded,
regardless of VM counters. The raw result remains valid diagnostic correctness
evidence. The public cap stays 65536 and P4/P5 remain open. The subsequent
projection-shape candidate is a prospective change, unbuilt and unmeasured at
this capture.

Command: `slotstream optimization-state-check --variant context-small-swept-aligned-64 --json`.

Portable process observations (timings excluded):

```json
{
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 28196749312,
    "swapins": 43798505,
    "swapouts": 77363385,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                    71715.\nPages active:                                1059289.\nPages inactive:                              1410178.\nPages speculative:                             76675.\nPages throttled:                                   0.\nPages wired down:                             223431.\nPages purgeable:                                4334.\n\"Translation faults\":                    14819138150.\nPages copy-on-write:                       688299696.\nPages zero filled:                       20001819078.\nPages reactivated:                        3290271429.\nPages purged:                               69448107.\nFile-backed pages:                           1644944.\nAnonymous pages:                              901198.\nPages stored in compressor:                  1434984.\nPages occupied by compressor:                 244308.\nDecompressions:                           1136418401.\nCompressions:                             1447108997.\nPageins:                                  7047236059.\nPageouts:                                   10959682.\nSwapins:                                    43798505.\nSwapouts:                                   77363385.\nPages tagged:                                 158082.\nPages tagged resident:                        131445.\nPages tagged compressed:                       26637.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 7056.\nPages tag-storage free:                          302.\nPages tag-storage non-tag pageable:            90938.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4681600.\nTagged compressions:                        10752796.\nTagged decompressions:                       9932469.\n"
  },
  "after": {
    "page_bytes": 16384,
    "reclaimable_bytes": 27800567808,
    "swapins": 43799199,
    "swapouts": 77363385,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   394931.\nPages active:                                1105337.\nPages inactive:                              1091665.\nPages speculative:                             12723.\nPages throttled:                                   0.\nPages wired down:                             235916.\nPages purgeable:                                  90.\n\"Translation faults\":                    14819555411.\nPages copy-on-write:                       688332816.\nPages zero filled:                       20007145826.\nPages reactivated:                        3290890108.\nPages purged:                               69456943.\nFile-backed pages:                           1301791.\nAnonymous pages:                              907934.\nPages stored in compressor:                  1434364.\nPages occupied by compressor:                 244835.\nDecompressions:                           1136419020.\nCompressions:                             1447108997.\nPageins:                                  7048016382.\nPageouts:                                   10959773.\nSwapins:                                    43799199.\nSwapouts:                                   77363385.\nPages tagged:                                 158144.\nPages tagged resident:                        131508.\nPages tagged compressed:                       26636.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 7056.\nPages tag-storage free:                          436.\nPages tag-storage non-tag pageable:            90804.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4681536.\nTagged compressions:                        10752796.\nTagged decompressions:                       9932469.\n"
  },
  "exit_code": 1,
  "passed": false,
  "assertions": 1605,
  "duration_seconds": 41.12630125
}
```
...
## small64-aligned-11/stdout.txt

SHA-256 `58058b26366d71ab5727c1dc623c70d9cad04afc262455aef908469f09d448c9`; 237090 bytes.
...
````text
{
  ...
  "name" : "context-small-pass-64-swept-router-padded-attention-aligned\/tokens=515\/prefix=0",
  "passed" : false
}

````

## small64-aligned-11/stderr.txt
