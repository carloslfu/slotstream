---
type: run
id: 01m1r5zhpr6ts39fejcwv4awd1
created: 2026-09-05T07:02:00.152572+00:00
updated: 2026-09-05T07:02:48.025591+00:00
summary: Socket saturation exposed a blocked send; corrected bounded queue passes 38 socket assertions and 74 live API checks
binary: Frozen V7 and V8 identities in body
captured_at: 2026-09-05
command: Exact commands in body
discarded: 'false'
machines: '[[records/machines/macbook-pro-m5-pro-48gb]]'
title: Bounded output queue evidence
tool: Native socket diagnostics and live API robustness
---
# Bounded output queue: blocked-send counterexample and correction

Partial OPT30 implementation, all new optimization controls still default off. The queue bounds retained wire bytes and frames, counting the worker's in-flight Data against the same budget. The inference callback enqueues without waiting and cancels if the bound is reached. A separate writer handles the socket; a monotonic deadline bounds sends and the total final drain outside the engine lock. Queued frames/bytes and bytes actually accepted by the socket remain separate counters. These counters do not claim delivery to the peer application.

The first V7 real-socket diagnostic hung at the in-flight saturation assertion. A live stack shows the worker inside __sendto despite MSG_DONTWAIT and the main thread waiting for the mandatory writer join. Its own PID was terminated after the stack capture; the wrapper reports an empty-JSON error because the diagnostic never completed. This is a failed implementation gate, not a passing check or a model fault.

V8 sets O_NONBLOCK on the descriptor after request parsing, shuts down writes when cancelling, and restores the original flags only after joining the worker. The real socket-pair gate then passed 38 assertions, covering empty/idempotent finish, exact FIFO bytes across UTF-8/framing splits, atomically rejected oversized frames, in-flight saturation, a non-reading peer, bounded cleanup, partial-byte accounting, closed-peer SIGPIPE safety and descriptor restoration.

The optional queue is wired into Ollama chat/generate, OpenAI SSE and Gateway output, including Gateway keepalives. Cancellation checks observe the writer failure latch, and the OpenAI handler no longer attempts an HTTP JSON fallback inside a failed streaming response. API duration and Gateway keepalive interval measurements use the monotonic clock; actual timestamps remain wall-clock values. Opt-in benchmark metadata includes a clearly named pre-completion-frame queue snapshot; final writer delivery observation remains a future integration step.

On frozen V8, all 21 T0/T1 catalogue groups passed and the real existing API robustness suite passed all 74 checks with the queue, compact state/row ownership and terminal-forward control enabled. The server used a fixed 8.1 GB target, 13 experts/layer, MTP off and no elastic resizing. The suite verifies streamed/nonstreamed text parity over ten scalar/stop cases, metadata responsiveness during inference and client disconnect survival. It does not yet establish a real TCP non-reading-client timeout or a Gateway tool-call queue integration gate. No speed claim or default adoption is made from correctness tests.

## .build/optimization/candidate-output-queue-v7/build-identity.json

SHA-256: `eed5f43a43f4016bb8c0a1ce091b0c873ffe0510f6769b7aae0f7ab4ca1df3c7`
...
```text
{
  "source": {
    ...
    "Sources/Slotstream/BoundedOutput.swift": "899e8056c6aac68aeb973ae37ce915e51751e3cb47cc005a005b3de0e7bae756",
    ...
    "Sources/SlotstreamDiagnostics/Diagnostics+Output.swift": "c109cfcc76dbd3297eeed1082bd0e73a237540353866903aa88eb2f87aea62ba",
    ...
    "Sources/slotstream-cli/OptimizationCommands.swift": "407d07dc6f8804e8314d83478a09811d168f19dc0aec22cbe79955ae5b751dd2",
  ...
  "source_archive_sha256": "5a51e031478c250d34d6c8511fc54a04cfd45a66df894d6992e92ef3aa38008e",
  "binary_sha256": "e6ae6bdd18722d694ff5499ec3d07330c06fe9f4fc8f29390d5346e3b84b6f7a",
  "metallib_sha256": "198488eb61359e953580a9c4530400feee1a06dd2f28a930a6ffa58aec66a597"
}

```

## .build/optimization/candidate-output-queue-v8/build-identity.json

SHA-256: `23ed82bbfedd3cbc2858efd8a385f3b0f696ed73a6573d869e9cb2ca33c5d414`
...
```text
{
  ...
  "source_archive_sha256": "daf28a991683441cef150ce6cc09fdac7ffe926e76733e988c8b2f7df4041184",
  "binary_sha256": "96e910d9939d9df52ddfd5b00ec9e50beeb26d6e51c5a8358b4ad96715e3897e",
  "metallib_sha256": "198488eb61359e953580a9c4530400feee1a06dd2f28a930a6ffa58aec66a597"
}

```

## .build/optimization/output-queue-v7/live-stack.txt

SHA-256: `ade865fddfe3d8dd4fcc94d5e2f4d7f5da01451a9331bf2b4ff342af62819f50`

```text
Analysis of sampling slotstream (pid 134) every 1 millisecond
Process:         slotstream [134]
Path:            /Users/USER/*/slotstream
Load Address:    0x104d0c000
Identifier:      slotstream
Version:         0
Code Type:       ARM64
Platform:        macOS
Parent Process:  Python [132]
Target Type:     live task

Date/Time:       2026-09-05 01:52:12.671 -0500
Launch Time:     2026-09-05 01:51:02.188 -0500
OS Version:      macOS 26.6.2 (25G83)
Report Version:  7
Analysis Tool:   /usr/bin/sample

Physical footprint:         3249K
Physical footprint (peak):  3249K
Idle exit:                  untracked
----

Call graph:
    798 Thread_35225530   DispatchQueue_1: com.apple.main-thread  (serial)
    + 798 start  (in dyld) + 6992  [0x185f644e4]
    +   798 main  (in slotstream) + 96  [0x105bd95e0]  main.swift:1341
    +     798 protocol witness for ParsableCommand.run() in conformance OptimizationStateCheck  (in slotstream) + 52  [0x105c1ff84]  /<compiler-generated>:0
    +       798 OptimizationStateCheck.run()  (in slotstream) + 984  [0x105c1ec5c]  OptimizationCommands.swift:19
    +         798 static Diagnostics.optimizationOutput()  (in slotstream) + 4624  [0x105ba43f0]  Diagnostics+Output.swift:84
    +           798 BoundedOutput.finish()  (in slotstream) + 284  [0x105abedf0]  BoundedOutput.swift:97
    +             798 _dispatch_group_wait_slow  (in libdispatch.dylib) + 56  [0x186175c38]
    +               798 _dlock_wait  (in libdispatch.dylib) + 56  [0x1861758cc]
    +                 798 __ulock_wait  (in libsystem_kernel.dylib) + 8  [0x1862edaf8]
    798 Thread_35225538   DispatchQueue_32: slotstream.socket-output  (serial)
      798 start_wqthread  (in libsystem_pthread.dylib) + 8  [0x18632ac10]
        798 _pthread_wqthread  (in libsystem_pthread.dylib) + 292  [0x18632bec0]
          798 _dispatch_workloop_worker_thread  (in libdispatch.dylib) + 720  [0x186186734]
            798 _dispatch_root_queue_drain_deferred_wlh  (in libdispatch.dylib) + 284  [0x186186e34]
              798 _dispatch_lane_invoke  (in libdispatch.dylib) + 392  [0x18617cb2c]
                798 _dispatch_lane_serial_drain  (in libdispatch.dylib) + 740  [0x18617c030]
                  798 _dispatch_client_callout  (in libdispatch.dylib) + 16  [0x18618d4b0]
                    798 _dispatch_call_block_and_release  (in libdispatch.dylib) + 32  [0x186173a28]
                      798 thunk for @escaping @callee_guaranteed @Sendable () -> ()  (in slotstream) + 28  [0x105abe840]  /<compiler-generated>:0
                        798 BoundedOutput.work()  (in slotstream) + 1020  [0x105abe744]  BoundedOutput.swift:116
                          798 closure #1 in BoundedOutput.write(_:)  (in slotstream) + 360  [0x105abef90]  BoundedOutput.swift:133
                            798 __sendto  (in libsystem_kernel.dylib) + 8  [0x1862f0390]

Total number in stack (recursive counted multiple, when >=5):

Sort by top of stack, same collapsed (when >= 5):
        __sendto  (in libsystem_kernel.dylib)        798
        __ulock_wait  (in libsystem_kernel.dylib)        798

Binary Images:
       0x104d0c000 -        0x105f7d6c7 +slotstream (0) <6F213A45-2B82-3DB2-996A-8031B6EF0E8D> /Users/*/slotstream
...
## .build/optimization/output-queue-v7/manifest.json

SHA-256: `22504864f25cecbda6b787d60d35f1f0bf6e81def51e46b408fb758b7c51894d`

```text
{
  "binary": "/Users/carlos/Projects/slotstream/.build/optimization/candidate-output-queue-v7/slotstream",
  "identity": {
    "source": {
      "Makefile": "9a594e9293f729364cc3c6cfd8574bbe383eb7a88d37037067a15a071fde7c0c",
      "Package.resolved": "6fc23da3ddc636949e84042cb70da34bc93c4355feef14857880caa6c3c7fceb",
  ...
  "timeout_seconds": 600,
  "command": [
    "/Users/carlos/Projects/slotstream/.build/optimization/candidate-output-queue-v7/slotstream",
  ...
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 29139304448,
    "swapins": 41697470,
    "swapouts": 69915921,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   111743.\nPages active:                                1140829.\nPages inactive:                               806475.\nPages speculative:                            349227.\nPages throttled:                                   0.\nPages wired down:                             261311.\nPages purgeable:                                3102.\n\"Translation faults\":                    13708303367.\nPages copy-on-write:                       623370603.\nPages zero filled:                       14728325876.\nPages reactivated:                        2140769189.\nPages purged:                               61084965.\nFile-backed pages:                           1663677.\nAnonymous pages:                              632854.\nPages stored in compressor:                  1386385.\nPages occupied by compressor:                 413108.\nDecompressions:                            954277296.\nCompressions:                             1247627533.\nPageins:                                  5697144754.\nPageouts:                                   10613611.\nSwapins:                                    41697470.\nSwapouts:                                   69915921.\nPages tagged:                                 177672.\nPages tagged resident:                        130166.\nPages tagged compressed:                       47506.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6949.\nPages tag-storage free:                         2811.\nPages tag-storage non-tag pageable:            88536.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    7745024.\nTagged compressions:                         9281933.\nTagged decompressions:                       8535009.\n"
  },
  "exit_code": -15,
  "error": "JSONDecodeError: Expecting value: line 1 column 1 (char 0)",
  "duration_seconds": 126.690972416,
  "after": {
    "page_bytes": 16384,
    "reclaimable_bytes": 28596027392,
    "swapins": 41697478,
    "swapouts": 69915921,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                    19222.\nPages active:                                1207871.\nPages inactive:                               860377.\nPages speculative:                            346503.\nPages throttled:                                   0.\nPages wired down:                             261642.\nPages purgeable:                               14610.\n\"Translation faults\":                    13709282489.\nPages copy-on-write:                       623435742.\nPages zero filled:                       14729062442.\nPages reactivated:                        2140770010.\nPages purged:                               61085086.\nFile-backed pages:                           1711531.\nAnonymous pages:                              703222.\nPages stored in compressor:                  1357686.\nPages occupied by compressor:                 389739.\nDecompressions:                            954302171.\nCompressions:                             1247627533.\nPageins:                                  5697173146.\nPageouts:                                   10613611.\nSwapins:                                    41697478.\nSwapouts:                                   69915921.\nPages tagged:                                 176973.\nPages tagged resident:                        130439.\nPages tagged compressed:                       46534.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6952.\nPages tag-storage free:                          187.\nPages tag-storage non-tag pageable:            91157.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    7567104.\nTagged compressions:                         9281933.\nTagged decompressions:                       8535936.\n"
  }
}

```

## .build/optimization/output-queue-v7/stderr.txt
...
## .build/optimization/output-queue-v7/stdout.txt
...
## .build/optimization/output-queue-v8/manifest.json

SHA-256: `c65fe3cb7772dd994532e8430646ea0308179959b0bf3eb5f179ad43329ac5b0`

```text
{
  "binary": "/Users/carlos/Projects/slotstream/.build/optimization/candidate-output-queue-v8/slotstream",
  "identity": {
    "source": {
      "Makefile": "9a594e9293f729364cc3c6cfd8574bbe383eb7a88d37037067a15a071fde7c0c",
      "Package.resolved": "6fc23da3ddc636949e84042cb70da34bc93c4355feef14857880caa6c3c7fceb",
  ...
  "timeout_seconds": 30,
  "command": [
    "/Users/carlos/Projects/slotstream/.build/optimization/candidate-output-queue-v8/slotstream",
    "optimization-state-check",
    "--variant",
    "output",
    "--json"
  ...
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 27952496640,
    "swapins": 41697486,
    "swapouts": 69915921,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   104188.\nPages active:                                1170164.\nPages inactive:                              1023116.\nPages speculative:                            156281.\nPages throttled:                                   0.\nPages wired down:                             251241.\nPages purgeable:                               17374.\n\"Translation faults\":                    13710361499.\nPages copy-on-write:                       623486799.\nPages zero filled:                       14729885793.\nPages reactivated:                        2140770662.\nPages purged:                               61085301.\nFile-backed pages:                           1584523.\nAnonymous pages:                              765038.\nPages stored in compressor:                  1333059.\nPages occupied by compressor:                 380389.\nDecompressions:                            954326597.\nCompressions:                             1247627533.\nPageins:                                  5697227748.\nPageouts:                                   10613616.\nSwapins:                                    41697486.\nSwapouts:                                   69915921.\nPages tagged:                                 178925.\nPages tagged resident:                        133505.\nPages tagged compressed:                       45420.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6951.\nPages tag-storage free:                          214.\nPages tag-storage non-tag pageable:            91131.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    7351936.\nTagged compressions:                         9281933.\nTagged decompressions:                       8537009.\n"
  },
  "exit_code": 0,
  "result_key": "passed",
  "assertions": 38,
  "duration_seconds": 0.613287667,
  "after": {
    "page_bytes": 16384,
    "reclaimable_bytes": 27859124224,
    "swapins": 41697486,
    "swapouts": 69915921,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   103884.\nPages active:                                1162181.\nPages inactive:                              1022907.\nPages speculative:                            156383.\nPages throttled:                                   0.\nPages wired down:                             259652.\nPages purgeable:                               12051.\n\"Translation faults\":                    13710369487.\nPages copy-on-write:                       623487214.\nPages zero filled:                       14729890680.\nPages reactivated:                        2140770662.\nPages purged:                               61085301.\nFile-backed pages:                           1584451.\nAnonymous pages:                              757020.\nPages stored in compressor:                  1333050.\nPages occupied by compressor:                 380389.\nDecompressions:                            954326606.\nCompressions:                             1247627533.\nPageins:                                  5697227793.\nPageouts:                                   10613616.\nSwapins:                                    41697486.\nSwapouts:                                   69915921.\nPages tagged:                                 178833.\nPages tagged resident:                        133413.\nPages tagged compressed:                       45420.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6951.\nPages tag-storage free:                          185.\nPages tag-storage non-tag pageable:            91160.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    7351936.\nTagged compressions:                         9281933.\nTagged decompressions:                       8537009.\n"
  }
}

```

## .build/optimization/output-queue-v8/stderr.txt
...
## .build/optimization/output-queue-v8/stdout.txt

SHA-256: `b115acc04808b85ea6b5039c5f14487dbed215d2657979c3b2e2bd878ddc563e`
...
## .build/optimization/catalogue-v8.json

SHA-256: `e57a1a18d02363650225012aba9ed8394a91183d00ba353ac8eecd07611a0d64`
...
## .build/optimization/api-output-queue-v8/manifest.json

SHA-256: `171a211dd113fb4df97f21a332bc5dc98e75e12ff87aa4a535b9bb067233f55e`

```text
{
  "classification": "correctness only; no timing claim",
  "command": [
    "bash",
  ...
  "environment": {
    "SLOTSTREAM_TEST_BINARY": "/Users/carlos/Projects/slotstream/.build/optimization/candidate-output-queue-v8/slotstream",
    "SLOTSTREAM_TEST_MEMORY_GB": "8.1",
    "SLOTSTREAM_TEST_MTP": "off",
    "SLOTSTREAM_TEST_LOG": "/Users/carlos/Projects/slotstream/.build/optimization/api-output-queue-v8/server.log",
  ...
  "harness_sha256": "548210feaafc6e00bcc7b243cf41f56566a136f422b324fb20d424e27a925b7b",
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 27432796160,
    "swapins": 41697486,
    "swapouts": 69915921,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                    58150.\nPages active:                                1212968.\nPages inactive:                              1053471.\nPages speculative:                            161209.\nPages throttled:                                   0.\nPages wired down:                             233538.\nPages purgeable:                               16740.\n\"Translation faults\":                    13710945750.\nPages copy-on-write:                       623503884.\nPages zero filled:                       14730389239.\nPages reactivated:                        2140771040.\nPages purged:                               61085305.\nFile-backed pages:                           1599475.\nAnonymous pages:                              828173.\nPages stored in compressor:                  1300503.\nPages occupied by compressor:                 365809.\nDecompressions:                            954353827.\nCompressions:                             1247627533.\nPageins:                                  5697229061.\nPageouts:                                   10613616.\nSwapins:                                    41697486.\nSwapouts:                                   69915921.\nPages tagged:                                 178854.\nPages tagged resident:                        134316.\nPages tagged compressed:                       44538.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6951.\nPages tag-storage free:                          449.\nPages tag-storage non-tag pageable:            90896.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    7172736.\nTagged compressions:                         9281933.\nTagged decompressions:                       8537869.\n"
  },
  "exit_code": 0,
  "duration_seconds": 182.28067775,
  "after": {
    "page_bytes": 16384,
    "reclaimable_bytes": 30082940928,
    "swapins": 41697561,
    "swapouts": 69922789,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   521487.\nPages active:                                 940097.\nPages inactive:                               931678.\nPages speculative:                             52505.\nPages throttled:                                   0.\nPages wired down:                             234025.\nPages purgeable:                                6990.\n\"Translation faults\":                    13715360974.\nPages copy-on-write:                       623958271.\nPages zero filled:                       14732446957.\nPages reactivated:                        2141622476.\nPages purged:                               61116073.\nFile-backed pages:                           1307640.\nAnonymous pages:                              616640.\nPages stored in compressor:                  1366745.\nPages occupied by compressor:                 403963.\nDecompressions:                            954502765.\nCompressions:                             1247902295.\nPageins:                                  5703353975.\nPageouts:                                   10616016.\nSwapins:                                    41697561.\nSwapouts:                                   69922789.\nPages tagged:                                 175724.\nPages tagged resident:                        134228.\nPages tagged compressed:                       41496.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                 6948.\nPages tag-storage free:                         1801.\nPages tag-storage non-tag pageable:            89547.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    6580608.\nTagged compressions:                         9283822.\nTagged decompressions:                       8542728.\n"
  }
}

```

## .build/optimization/api-output-queue-v8/stdout.txt

SHA-256: `f7a451a5bfdbfbc97f15d9ac93d6439531f7ebfc3cbd8e9fb9d440d149134159`
...
## .build/optimization/api-output-queue-v8/stderr.txt

SHA-256: `5f05e68a94141d9d526d58e8048518f9e3f4d313b9f478253e3c9219bc4ad091`
...
## .build/optimization/api-output-queue-v8/server.log

SHA-256: `ad7f48f3fbc857a46381193048ee4879e4ea706279f6b3852d8843d0045e7efa`
...
## .build/optimization/api-output-queue-v8/harness.sh

SHA-256: `548210feaafc6e00bcc7b243cf41f56566a136f422b324fb20d424e27a925b7b`
