---
type: run
id: 01m1x3959enkvv0gd1zz82mqk7
created: 2026-09-07T04:51:01.550456+00:00
updated: 2026-09-07T04:51:01.772718+00:00
summary: Full-cache two-cell execution and resource refusal
binary: V202b64b07cff525003546694e8a129d7996a11987fb9b5350b47e0a882b9c848daf
captured_at: 2026-09-07
command: python3 /tmp/slotstream-optimization-execution/run_ngram_v244.py
discarded: 'true'
machines: '[[records/machines/macbook-pro-m5-pro-48gb]]'
title: Full-cache two-cell execution and resource refusal
tool: Frozen V205 component study under V244 bounded interval
---
# Original full-cache study with two native cells and preserved refusal

V244 executes the original V205 protocol without changing thresholds, workload, fixed seven-round order or frozen drivers. Two first-round native cells complete with checked output hashes equal. Reference has four new swapins and no swapouts, so its timing is excluded; compact is individually VM-valid. Before the third cell, the unchanged12GB preflight refuses9.19GB and the study stops after327.401860042seconds overall. No ring cell executes, there are no clean complete comparison pairs, and all adoption criteria remain false. This is an incomplete resource-constrained study, not a qualified compact/ring improvement, performance failure, serving result or replacement for prior refusals. Fresh handback verifies no model process/lock holder, all143runtime and frozen3drivers unchanged, no planner-family file/default change. Reclaimable memory has recovered to13.542014976GB by that later handback observation; that does not retroactively make the refused cell eligible. Both original zero-cell attempts are retained. No inferred speed or memory percentage follows.

## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/01-compact/stderr.txt
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/01-compact/stdout.json

SHA-256 `6f6d9dc924023bd851420e701a18d7bc660e3d491ec8d2c4b4ebb30509a2ac63`; 2867 bytes.

````text
{
  "items" : [
    {
      "name" : "actual row representation",
      "passed" : true
    },
    {
      "name" : "actual FIFO representation",
      "passed" : true
    },
    {
      "name" : "large cache reached eviction regime",
      "passed" : true
    },
    {
      "name" : "payload follows actual retained rows",
      "passed" : true
    },
    {
      "name" : "warm assembly reads no new rows",
      "passed" : true
    },
    {
      "name" : "warm assembly preserves cache occupancy",
      "passed" : true
    },
    {
      "name" : "cache-hit output matches the original fill",
      "passed" : true
    },
    {
      "name" : "measured phase crosses a full eviction batch",
      "passed" : true
    },
    {
      "name" : "cache remains bounded after eviction",
      "passed" : true
    },
    {
      "name" : "all row workers joined",
      "passed" : true
    },
    {
      "name" : "complete component VM interval is observable",
      "passed" : true
    },
    {
      "name" : "sampled footprint is bounded",
      "passed" : true
    },
    {
      "name" : "lifetime RSS is separately bounded",
      "passed" : true
    },
    {
      "detail" : "d9b712d8164b90904a4f33889048c49750aa7784939c64548348174bfb649531",
      "name" : "sha256:eviction_embeddings",
      "passed" : true
    },
    {
      "detail" : "7092f2d2bfb978e5558c1f92db17f6e941b945f2e76fd59206e647bb7e526eb1",
      "name" : "sha256:fill_embeddings",
      "passed" : true
    },
    {
      "detail" : "ab7d6c3ad99d9ad808c4a9297f7991c9fc4ae77113af559339488af9f7751046",
      "name" : "sha256:input_ids",
      "passed" : true
    },
    {
      "detail" : "6dad1d10558fbe320ce1b0163b1ac21c4b79513858d6b225d9504aa69ae1354f",
      "name" : "sha256:warm_embedding",
      "passed" : true
    }
  ],
  "measurements" : {
    "compact" : 1,
    "end_payload_bytes" : 124597440,
    "end_rows" : 389367,
    "eviction_assembly_seconds" : 1.3934912930000005,
    "eviction_row_misses" : 65463,
    "eviction_tokens" : 4096,
    "fill_seconds_including_hash" : 11.5872935,
    "fill_tokens" : 32768,
    "filled_payload_bytes" : 116449280,
    "filled_rows" : 363904,
    "lifetime_rss_peak_bytes" : 2081456128,
    "mlx_active_bytes" : 2604697756,
    "nominal_thermal_endpoints" : 1,
    "normal_power_endpoints" : 1,
    "physical_before_bytes" : 2687978088,
    "physical_end_bytes" : 2792753936,
    "physical_filled_bytes" : 2792672016,
    "ring" : 0,
    "sampled_count" : 655,
    "sampled_peak_bytes" : 2840070928,
    "swapins_after" : 44107469,
    "swapins_before" : 44107469,
    "swapouts_after" : 77510858,
    "swapouts_before" : 77510858,
    "tile_tokens" : 256,
    "warm_assembly_seconds_per_call" : 0.0005956959609375,
    "warm_calls" : 128,
    "warm_row_hits" : 524288
  },
  "name" : "optimization-ngram-cache-compact",
  "passed" : true
}
````

## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/01-reference/stderr.txt
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/01-reference/stdout.json

SHA-256 `40e36550fa25df3ac709db0503b7e2fb7c83ad23f9eb7839e0f8b729669968d5`; 2868 bytes.
...
````text
{
  ...
  "measurements" : {
    "compact" : 0,
    "end_payload_bytes" : 249194880,
    "end_rows" : 389367,
    "eviction_assembly_seconds" : 1.2029919579999997,
    "eviction_row_misses" : 65463,
    "eviction_tokens" : 4096,
    "fill_seconds_including_hash" : 9.8437595,
    "fill_tokens" : 32768,
    "filled_payload_bytes" : 232898560,
    "filled_rows" : 363904,
    "lifetime_rss_peak_bytes" : 2992586752,
    "mlx_active_bytes" : 2604697756,
    "nominal_thermal_endpoints" : 1,
    "normal_power_endpoints" : 1,
    "physical_before_bytes" : 2687207968,
    "physical_end_bytes" : 2981022552,
    "physical_filled_bytes" : 3014298456,
    "ring" : 0,
    "sampled_count" : 557,
    "sampled_peak_bytes" : 3052342104,
    "swapins_after" : 44107449,
    "swapins_before" : 44107445,
    "swapouts_after" : 77510858,
    "swapouts_before" : 77510858,
    "tile_tokens" : 256,
    "warm_assembly_seconds_per_call" : 0.0004478330078125,
    "warm_calls" : 128,
    "warm_row_hits" : 524288
  },
  "name" : "optimization-ngram-cache-reference",
  "passed" : true
}
````

## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/completion.json

SHA-256 `b6cd6d55ff6abc15505fa6f0c693589a58338bdde3ed285667c411ca36922e0c`; 1135 bytes.

````text
{
  "completed": false,
  "error": "InsufficientHeadroom: 9.19 GB reclaimable; need 12.00 GB",
  "seconds": 327.2101595,
  "sources_unchanged": true,
  "assessment": {
    "fixed_study_completed": false,
    "all_completed_outputs_exact": true,
    "comparisons": [
      {
        "reference": "reference",
        "candidate": "compact",
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/manifest.json
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/ngram-cache-v205-protocol.json
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/ngram_cache_probe.py
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/prefill_bench.py
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/rows.json

SHA-256 `a1daf2e7a9b7bfb75247a65118bce9e295ff4bcdfa9483258cd8d9ece59ae928`; 12226 bytes.
...
[
  {
    ...
    "command": [
      ...
      "--variant",
      "ngram-cache-reference",
      "--json"
    ],
    "before": {
      "page_bytes": 16384,
      "reclaimable_bytes": 15032565760,
      "swapins": 44107445,
      "swapouts": 77510858,
      "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   139663.\nPages active:                                1037562.\nPages inactive:                              1022675.\nPages speculative:                             13762.\nPages throttled:                                   0.\nPages wired down:                             261669.\nPages purgeable:                               28952.\n\"Translation faults\":                    15244881890.\nPages copy-on-write:                       722524906.\nPages zero filled:                       21034877278.\nPages reactivated:                        3462561216.\nPages purged:                               71648007.\nFile-backed pages:                            748900.\nAnonymous pages:                             1325099.\nPages stored in compressor:                  1468373.\nPages occupied by compressor:                 609369.\nDecompressions:                           1166277206.\nCompressions:                             1479545304.\nPageins:                                  7588377250.\nPageouts:                                   11038409.\nSwapins:                                    44107445.\nSwapouts:                                   77510858.\nPages tagged:                                 181571.\nPages tagged resident:                        155106.\nPages tagged compressed:                       26465.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13925.\nPages tag-storage free:                          809.\nPages tag-storage non-tag pageable:            83562.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4013760.\nTagged compressions:                        11115942.\nTagged decompressions:                      10275997.\n"
    },
    "valid": false,
    "returncode": 0,
    "after": {
      "page_bytes": 16384,
      "reclaimable_bytes": 14346813440,
      "swapins": 44107449,
      "swapouts": 77510858,
      "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   199040.\nPages active:                                 967499.\nPages inactive:                               963813.\nPages speculative:                              2957.\nPages throttled:                                   0.\nPages wired down:                             317227.\nPages purgeable:                                5568.\n\"Translation faults\":                    15245647413.\nPages copy-on-write:                       722526332.\nPages zero filled:                       21035684120.\nPages reactivated:                        3462689054.\nPages purged:                               71648025.\nFile-backed pages:                            671052.\nAnonymous pages:                             1263217.\nPages stored in compressor:                  1523419.\nPages occupied by compressor:                 634053.\nDecompressions:                           1166277445.\nCompressions:                             1479600667.\nPageins:                                  7588515609.\nPageouts:                                   11038509.\nSwapins:                                    44107449.\nSwapouts:                                   77510858.\nPages tagged:                                 181143.\nPages tagged resident:                        149963.\nPages tagged compressed:                       31180.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13644.\nPages tag-storage free:                         1070.\nPages tag-storage non-tag pageable:            83582.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4828352.\nTagged compressions:                        11120672.\nTagged decompressions:                      10276000.\n"
    },
    "report_sha256": "40e36550fa25df3ac709db0503b7e2fb7c83ad23f9eb7839e0f8b729669968d5",
    "observation": {
      "metrics": {
        "compact": 0,
        "end_payload_bytes": 249194880,
      ...
      "hashes": {
        "eviction_embeddings": "d9b712d8164b90904a4f33889048c49750aa7784939c64548348174bfb649531",
        "fill_embeddings": "7092f2d2bfb978e5558c1f92db17f6e941b945f2e76fd59206e647bb7e526eb1",
        "input_ids": "ab7d6c3ad99d9ad808c4a9297f7991c9fc4ae77113af559339488af9f7751046",
        "warm_embedding": "6dad1d10558fbe320ce1b0163b1ac21c4b79513858d6b225d9504aa69ae1354f"
      },
  ...
  },
  {
    ...
    "before": {
      "page_bytes": 16384,
      "reclaimable_bytes": 12125798400,
      "swapins": 44107469,
      "swapouts": 77510858,
      "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                     4165.\nPages active:                                1087774.\nPages inactive:                              1078996.\nPages speculative:                              5819.\nPages throttled:                                   0.\nPages wired down:                             292394.\nPages purgeable:                               10335.\n\"Translation faults\":                    15246715131.\nPages copy-on-write:                       722605087.\nPages zero filled:                       21036443507.\nPages reactivated:                        3462689597.\nPages purged:                               71649736.\nFile-backed pages:                            725600.\nAnonymous pages:                             1446989.\nPages stored in compressor:                  1494090.\nPages occupied by compressor:                 616202.\nDecompressions:                           1166291725.\nCompressions:                             1479600667.\nPageins:                                  7588558517.\nPageouts:                                   11039296.\nSwapins:                                    44107469.\nSwapouts:                                   77510858.\nPages tagged:                                 181137.\nPages tagged resident:                        150894.\nPages tagged compressed:                       30243.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13644.\nPages tag-storage free:                          173.\nPages tag-storage non-tag pageable:            84479.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4629568.\nTagged compressions:                        11120672.\nTagged decompressions:                      10276936.\n"
    },
    "valid": true,
    "returncode": 0,
    "after": {
      "page_bytes": 16384,
      "reclaimable_bytes": 14733819904,
      "swapins": 44107469,
      "swapouts": 77510858,
      "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   189385.\nPages active:                                 926787.\nPages inactive:                               916682.\nPages speculative:                              7810.\nPages throttled:                                   0.\nPages wired down:                             273871.\nPages purgeable:                               12403.\n\"Translation faults\":                    15247309478.\nPages copy-on-write:                       722614625.\nPages zero filled:                       21036880286.\nPages reactivated:                        3462923338.\nPages purged:                               71653445.\nFile-backed pages:                            697493.\nAnonymous pages:                             1153786.\nPages stored in compressor:                  1816883.\nPages occupied by compressor:                 769384.\nDecompressions:                           1166409917.\nCompressions:                             1480190570.\nPageins:                                  7588668979.\nPageouts:                                   11039526.\nSwapins:                                    44107469.\nSwapouts:                                   77510858.\nPages tagged:                                 180225.\nPages tagged resident:                        148324.\nPages tagged compressed:                       31901.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13641.\nPages tag-storage free:                         1617.\nPages tag-storage non-tag pageable:            83038.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4932608.\nTagged compressions:                        11122413.\nTagged decompressions:                      10277013.\n"
    },
    "report_sha256": "6f6d9dc924023bd851420e701a18d7bc660e3d491ec8d2c4b4ebb30509a2ac63",
    "observation": {
      "metrics": {
        "compact": 1,
        "end_payload_bytes": 124597440,
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244/serve_bench.py
...
## /Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244-launch.json

SHA-256 `7a8135b5aecc78e3b9ad3dee9e367c322415f2b05931347b60c70b728c5b8ada`; 5174 bytes.
...
````text
{
  ...
  "command": [
    ...
    "--out",
    "/Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v244"
  ],
  "protocol_sha256": "5c5e74e4da45811cce9acff02ae25acd8adb5b20422d481ed1d512cde60ff61b",
  "wrapper_sha256": "7742120767509813f4cd0dd0ff2e2caba3195d7187bab486a26881a0e7b0959e",
  "wrapper_pid": 6365,
  "work_seconds": 5400,
  "cleanup_seconds": 60,
  "drivers": {
  ...
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 14876540928,
    "swapins": 44107391,
    "swapouts": 77510858,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   159078.\nPages active:                                 962146.\nPages inactive:                              1014517.\nPages speculative:                              9300.\nPages throttled:                                   0.\nPages wired down:                             278587.\nPages purgeable:                               20471.\n\"Translation faults\":                    15242389144.\nPages copy-on-write:                       722314847.\nPages zero filled:                       21033426946.\nPages reactivated:                        3462559501.\nPages purged:                               71647086.\nFile-backed pages:                            728443.\nAnonymous pages:                             1257520.\nPages stored in compressor:                  1572740.\nPages occupied by compressor:                 661872.\nDecompressions:                           1166185483.\nCompressions:                             1479545304.\nPageins:                                  7588360275.\nPageouts:                                   11038409.\nSwapins:                                    44107391.\nSwapouts:                                   77510858.\nPages tagged:                                 181373.\nPages tagged resident:                        154448.\nPages tagged compressed:                       26925.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13925.\nPages tag-storage free:                          345.\nPages tag-storage non-tag pageable:            84026.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4072256.\nTagged compressions:                        11115942.\nTagged decompressions:                      10275594.\n"
  },
  "child_pid": 6432,
  "elapsed_seconds": 327.401860042,
  "exit_code": 1,
  "child_exit_code": 1,
  "after": {
    "page_bytes": 16384,
    "reclaimable_bytes": 9168306176,
    "swapins": 44107481,
    "swapouts": 77510858,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                     3823.\nPages active:                                1058777.\nPages inactive:                              1059462.\nPages speculative:                              3761.\nPages throttled:                                   0.\nPages wired down:                             283494.\nPages purgeable:                                4940.\n\"Translation faults\":                    15248394689.\nPages copy-on-write:                       722663913.\nPages zero filled:                       21037649490.\nPages reactivated:                        3462924032.\nPages purged:                               71656222.\nFile-backed pages:                            550826.\nAnonymous pages:                             1571174.\nPages stored in compressor:                  1641131.\nPages occupied by compressor:                 675831.\nDecompressions:                           1166563550.\nCompressions:                             1480190570.\nPageins:                                  7588702760.\nPageouts:                                   11039767.\nSwapins:                                    44107481.\nSwapouts:                                   77510858.\nPages tagged:                                 180305.\nPages tagged resident:                        148543.\nPages tagged compressed:                       31762.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13632.\nPages tag-storage free:                          245.\nPages tag-storage non-tag pageable:            84413.\nPages tag-storage non-tag wired:                  14.\nBytes of compressed tags:                    4909568.\nTagged compressions:                        11122413.\nTagged decompressions:                      10277133.\n"
  },
...
## /tmp/slotstream-optimization-execution/run_ngram_v244.py

SHA-256 `7742120767509813f4cd0dd0ff2e2caba3195d7187bab486a26881a0e7b0959e`; 3085 bytes.

````text
"""New bounded V244 attempt of the original V205 study; both prior zero-cell refusals preserved."""
from pathlib import Path
import json
import os
import signal
...
OUTPUT=ROOT/'.build/optimization/ngram-cache-v244'
RECEIPT=ROOT/'.build/optimization/ngram-cache-v244-launch.json'
...
## /tmp/slotstream-optimization-execution/full-cache-launch-v244/launch-readiness.json

SHA-256 `02c5c5fc5f1ef1006f07f09cbe70fdf86711027fb00a7054d109abdad7cbc311`; 3079 bytes.

````text
{
  "captured_at": "2026-09-07T04:41:32.053377+00:00",
  "classification": "Original V205 protocol under fresh bounded V244 interval; V205 and V239 zero-cell refusals preserved",
  "protocol_sha256": "5c5e74e4da45811cce9acff02ae25acd8adb5b20422d481ed1d512cde60ff61b",
  "wrapper_sha256": "7742120767509813f4cd0dd0ff2e2caba3195d7187bab486a26881a0e7b0959e",
  "prior_refusals": {
    "/Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v205-launch.json": "1bba1ee9534c1efb76a0e90951781ba35d48cffec476cf4ee4b292ce39662d4b",
    "/Users/carlos/Projects/slotstream/.build/optimization/ngram-cache-v239-launch.json": "e41b187881e4de38f26cd72bda572032cbc962928473526fea4229cf9a652f0b"
  },
  "drivers": {
    "ngram_cache_probe.py": "01e295b269d94350730c46a59edf7a62b562c9c45f6456c2d9947862835a57e7",
    "prefill_bench.py": "3e87578199e39ab74da394770f97fa834ad799a4af8a492adb7b4e41fe5c7036",
  ...
  "planner_comparison_complete": true,
  "eligible": true,
  "before": {
    "page_bytes": 16384,
    "reclaimable_bytes": 14875836416,
    "swapins": 44107391,
    "swapouts": 77510858,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   159037.\nPages active:                                 961993.\nPages inactive:                              1014508.\nPages speculative:                              9307.\nPages throttled:                                   0.\nPages wired down:                             278587.\nPages purgeable:                               20471.\n\"Translation faults\":                    15242363619.\nPages copy-on-write:                       722308714.\nPages zero filled:                       21033422974.\nPages reactivated:                        3462559501.\nPages purged:                               71647086.\nFile-backed pages:                            728441.\nAnonymous pages:                             1257367.\nPages stored in compressor:                  1572751.\nPages occupied by compressor:                 661876.\nDecompressions:                           1166185471.\nCompressions:                             1479545304.\nPageins:                                  7588360208.\nPageouts:                                   11038409.\nSwapins:                                    44107391.\nSwapouts:                                   77510858.\nPages tagged:                                 181373.\nPages tagged resident:                        154448.\nPages tagged compressed:                       26925.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13925.\nPages tag-storage free:                          345.\nPages tag-storage non-tag pageable:            84026.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    4072256.\nTagged compressions:                        11115942.\nTagged decompressions:                      10275594.\n"
  }
}
````

## /tmp/slotstream-optimization-execution/full-cache-launch-v244/return-audit.json

SHA-256 `de766762ffe44e80db2ea2c5c2a98f42f5a7977def4aafd8050c57be83ffdce3`; 2226 bytes.

````text
{
  "captured_at": "2026-09-07T04:48:30.581689+00:00",
  "vm": {
    "page_bytes": 16384,
    "reclaimable_bytes": 13542014976,
    "swapins": 44107497,
    "swapouts": 77510858,
    "raw": "Mach Virtual Memory Statistics: (page size of 16384 bytes)\nPages free:                                   257448.\nPages active:                                 943777.\nPages inactive:                               924631.\nPages speculative:                             17501.\nPages throttled:                                   0.\nPages wired down:                             270742.\nPages purgeable:                               10096.\n\"Translation faults\":                    15250127686.\nPages copy-on-write:                       722780352.\nPages zero filled:                       21038750000.\nPages reactivated:                        3462936453.\nPages purged:                               71656996.\nFile-backed pages:                            558995.\nAnonymous pages:                             1326914.\nPages stored in compressor:                  1629720.\nPages occupied by compressor:                 670945.\nDecompressions:                           1166583300.\nCompressions:                             1480215618.\nPageins:                                  7588736288.\nPageouts:                                   11039797.\nSwapins:                                    44107497.\nSwapouts:                                   77510858.\nPages tagged:                                 180425.\nPages tagged resident:                        145676.\nPages tagged compressed:                       34749.\nPages tag-storage:                             98304.\nPages tag-storage holding tags:                13365.\nPages tag-storage free:                          552.\nPages tag-storage non-tag pageable:            84379.\nPages tag-storage non-tag wired:                   8.\nBytes of compressed tags:                    5552640.\nTagged compressions:                        11125716.\nTagged decompressions:                      10277418.\n"
  },
  "competing_jobs": [],
  "lock_free": true,
  "shared_runtime_unchanged": true,
  "planner_family_absent": true,
