---
type: run
id: 01m20q9cq3x518g95pwg1hhnrn
created: 2026-09-08T14:38:23.971705+00:00
updated: 2026-09-08T14:38:24.240993+00:00
summary: Unprepared final campaign adapter normalizes source identity across macOS temporary-directory aliases
binary: /Users/carlos/Projects/slotstream/.build/optimization/compact-cache-fixed-mtp-build-v360/candidate/slotstream
captured_at: 2026-09-08
command: V372 one-line dependency-key correction and 17 model-free campaign tests
discarded: 'false'
machines: '[[records/machines/macbook-pro-m5-pro-48gb]]'
title: Unprepared final campaign adapter normalizes source identity across macOS temporary-directory aliases
tool: Slotstream exact native and source qualification capture
---
The same macOS temporary-directory alias issue found while validating the image runner is corrected in the still-unprepared V367 final-candidate campaign adapter. Dependency keys resolve to the physical file path before comparison. All original native evidence, controls, stage inventory, campaign execution/assessment, memory and deadline guards remain unchanged. The added alias check and all prior 16 model-free tests pass, totaling 17. Original V367 captured source remains preserved; before/after bytes and new tests are recorded here. No real campaign packet, model execution, final composition selection or activation exists.
...
[
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/after/campaign.py",
    "bytes": 18192,
    "sha256": "3f69817f07ae75b020f6f7677cb4de63455df3737673ea52eb64bcf2bf3258e3"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/after/test_campaign.py",
    "bytes": 9185,
    "sha256": "627b613934cae39a19ffc860b398005a3872dcadca1d8a43fc6ae4e94e4129fd"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/before/campaign.py",
    "bytes": 18182,
    "sha256": "0a61412c14c52c117e19f429c1b19c070f1f799eb8304e8320e3e11f71e95e0b"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/before/test_campaign.py",
    "bytes": 8864,
    "sha256": "2788b4c9f6cb161e3074e2c088f528fef10dc3988af4cbcfc65f3e7d87997d49"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/tests.stderr.txt",
    "bytes": 1403,
    "sha256": "2276a5a7d4d35e9a3ef2003263675daee228576a5617e059b92e48b4e2319fac"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/tests.stdout.txt",
    "bytes": 0,
    "sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
  },
  {
    "path": "/tmp/slotstream-optimization-execution/campaign-path-normalization-v372/verification.json",
    "bytes": 518,
    "sha256": "d651178099f606d59397245ec7b5128ec69e3f2522af8e0b3c5ce4249a885f41"
  }
]
```

## Artifact SHA-256 3f69817f07ae75b020f6f7677cb4de63455df3737673ea52eb64bcf2bf3258e3

Encoding: `utf-8`. Original bytes: 18192.
...
## Artifact SHA-256 627b613934cae39a19ffc860b398005a3872dcadca1d8a43fc6ae4e94e4129fd

Encoding: `utf-8`. Original bytes: 9185.
...
class CampaignTests(unittest.TestCase):
    ...
    def test_physical_dependency_identity_survives_tmp_alias(self):
        ...
        self.assertEqual(m.dependencies(), alias.dependencies())
...
## Artifact SHA-256 2276a5a7d4d35e9a3ef2003263675daee228576a5617e059b92e48b4e2319fac

Encoding: `utf-8`. Original bytes: 1403.
...
test_physical_dependency_identity_survives_tmp_alias (__main__.CampaignTests) ... ok
...
## Artifact SHA-256 d651178099f606d59397245ec7b5128ec69e3f2522af8e0b3c5ce4249a885f41

Encoding: `utf-8`. Original bytes: 518.
...
````````````text
{
  ...
  "real_campaign_prepared": false,
  "source_sha256": "3f69817f07ae75b020f6f7677cb4de63455df3737673ea52eb64bcf2bf3258e3",
  "tests_sha256": "627b613934cae39a19ffc860b398005a3872dcadca1d8a43fc6ae4e94e4129fd",
  "correction": "Dependency keys resolve physical paths, preserving identity across /tmp and /private/tmp. The V367 campaign remains unprepared. All original controls, native evidence, stage inventory, guard and acceptance code are unchanged."
}
