...
updated: 2026-09-13T13:44:49.924024+00:00
...
**September 11 revision:** [[records/decisions/draft-depth-defaults-to-two]] supersedes the draft-depth choice with the user-adopted default of two. The 120-experts/layer automatic activation floor remains in effect. The measurements above keep their original configurations.
**Addendum (2026-09-13).** The activation floor, the part [[records/decisions/draft-depth-defaults-to-two]] had kept, is replaced by [[records/decisions/draft-head-auto-floor-76-per-layer]].
