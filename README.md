...
> is still in development; the Slotstream CLI, APIs, and Swift package remain
> independently usable today. [See Sevra and join the waitlist](https://www.sevrahq.com/).
...
a second engine with a second cache tier, not a port. Windows and Linux support
is planned for Sevra; it is not available in the current engine.
